#!/usr/bin/env bash
# scripts/entrenar.sh
# Entrena el agente PPO con la función de recompensa ponderada.
# Correr desde la raíz del repo: bash scripts/entrenar.sh
...
print()
m_rl = evaluar(PPO.load("rl/models/ppo_semaforo_v1"), "Agente RL (500k pasos)")
